...
interface Guild {
	 ...
	 *
	 * @param array $options ['guild.id' => 'snowflake']
	 * @return \GuzzleHttp\Command\Result Returns active threads object with 'threads' as \RestCord\Model\Thread\Thread[] and 'members' as \RestCord\Model\Thread\Member[].
	 */
